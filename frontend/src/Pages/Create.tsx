  ...
  return (
    <div className="pt-[95px] pb-[40px] w-full lg:w-5xl m-auto flex flex-col items-center justify-center px-4 sm:px-[32px]">
      ...
      <div className="flex flex-col mb-[40px] text-center m-auto">
        ...
        >
          Transform your ideas into beautiful visuals with our powerful
          text-to-image generator.
        </p>
      </div>

      <div
        className={`p-6 w-full flex flex-col items-center justify-center hover:translate-y-[-5px] transition-all duration-400 ${
          mode == "Light"
            ? "shadow-[0_0_0_0.5px_rgb(23,13,41)]"
            : "shadow-[0_0_0_1px_rgb(23,13,41)]"
        } rounded-[10px] mb-[40px]`}
      >
        <h1
        ...
        <textarea
          ...
          className={`w-full p-[8px_12px] mt-[8px] min-h-[100px] outline-none focus:shadow-[inset_0_0_0_2px_#8740E5] rounded-[10px] ${
            mode === "Light"
              ? "text-black shadow-[0_0_0_0.5px_rgb(23,13,41)]"
              : "text-white shadow-[0_0_0_1px_rgb(23,13,41)]"
          }`}
          onChange={(e) => setInput(e.target.value)}
        ></textarea>

        {error && (
          <h1 className="text-[#7E1C1C] mt-[8px] font-medium w-full">
            {error}
          </h1>
        )}
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-3 mt-[24px] gap-5">
          ...
          <div>
            ...
            <select
              className={`focus:shadow-[inset_0_0_0_2px_#8740E5] rounded-[10px] p-[8px_12px] mt-[8px] outline-none w-full ${
                mode === "Light"
                  ? "text-black shadow-[0_0_0_0.5px_rgb(23,13,41)]"
      ...
      <div className="py-10 w-full ">
        <h1 className="colorAnimation text-[24px] mb-[24px]">
        ...
        <div
          className={`p-[24px] ${
            mode == "Light"
              ? "shadow-[0_0_0_0.5px_rgb(23,13,41)]"
              : "shadow-[0_0_0_1px_rgb(23,13,41)]"
          } rounded-[10px] min-h-[200px] flex items-center justify-center`}
        >
          {!authenticated && (
            <div
              className={`${
                mode == "Light"
                  ? "shadow-[0_0_0_0.5px_rgb(23,13,41)]"
                  : "shadow-[0_0_0_1px_rgb(23,13,41)]"
              } rounded-[10px] p-[32px] justify-center flex flex-col items-center w-full`}
            >
              <p
                className={`mb-[16px] ${
                  mode === "Light"
          ...
          {authenticated && imageUrl && (
            <img
              src={imageUrl}
              alt="Image"
              className="sm:w-[400px] sm:h-[400px] rounded-2xl"
            />
          )}
        </div>
      </div>
