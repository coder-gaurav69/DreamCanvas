...
const Login = () => {
  const { loginStatus, setLoginStatus, setAuthenticated } =
  ...
  return (
    <div
      ...
      } justify-center items-center fixed bg-[rgba(0,0,0,0.7)] ${
        mode == "Light" ? "backdrop-blur-[7px]" : "backdrop-blur-[2px]"
      } z-10 top-0 left-0 px-[30px]`}
    >
      <div
        className={`${
          isClosing ? "zoomOut" : "zoomIn"
        } w-full max-w-[450px] py-8 px-6 mx-auto flex flex-col justify-center items-center shadow-[0_0_0_0.3px_rgba(255,255,255,0.5)] z-20 rounded-[10px] ${
          mode == "Light"
            ? "bg-[rgba(255,255,255,0.2)] backdrop-blur-[1px]"
            : "bg-[#09090B]"
        } relative`}
      >
        {/* cross btn */}
        ...
        <div className="flex flex-col mb-[32px] text-center">
          <h1 className="colorAnimation text-2xl font-semibold">
            Welcome back
          </h1>
        ...
        >
          ...
          <div className="flex flex-col">
            ...
            <input
              ...
              className={`p-2 mt-2 focus:shadow-[0_0_0_1px_rgba(109,40,217,1)] rounded-lg outline-none shadow-[0_0_0_0.5px_rgba(109,40,217,0.3)] ${
                mode == "Light" ? "bg-[rgba(255,255,255,0.1)]" : "bg-black"
              }`}
          ...
          {/* submit btn */}
          <button
            className="bg-[#6D28D9] w-full mt-6 py-2 rounded-lg font-medium"
            onClick={login}
          >
            Sign in
          </button>
          ...
          <div className="flex items-center justify-center gap-2 my-6 text-sm">
            ...
            <p className="shrink-0 text-[rgba(255,255,255,0.5)]">
              or sign up with
            </p>
            <hr className="grow border-gray-500" />
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 text-xl mb-[24px]">
            <div
              className="shadow-[0_0_0_0.5px_rgba(255,255,255,0.2)] flex items-center justify-center rounded-lg py-2 hover:bg-[rgba(255,255,255,0.05)]"
              onClick={handle0AuthGoogleLogin}
            >
              <FcGoogle />
            </div>
            <div
              className="shadow-[0_0_0_0.5px_rgba(255,255,255,0.2)] flex items-center justify-center rounded-lg py-2 hover:bg-[rgba(255,255,255,0.05)]"
              onClick={handle0AuthFacebookLogin}
            >
              <FaFacebook className="text-[#2563EB]" />
            </div>
            <div
              className="shadow-[0_0_0_0.5px_rgba(255,255,255,0.2)] flex items-center justify-center rounded-lg py-2 hover:bg-[rgba(255,255,255,0.05)]"
              onClick={handle0AuthGithubLogin}
            >
